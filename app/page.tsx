      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16">
        <div className="absolute inset-0 pt-16">
          <img 
            ...
            alt="Cozy classroom environment" 
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0" style={{ background: 'linear-gradient(to bottom, rgba(250, 247, 242, 0.3), rgba(250, 247, 242, 0.5))' }} />
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                ...
                style={{ background: 'var(--background-cream)', border: '2px solid var(--border)' }}
              >
                <div 
            ...
            >
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { icon: '🧩', title: 'Puzzles', bg: '#E8F5F4' },
                  { icon: '📝', title: 'Quizzes', bg: '#F8E8E8' },
            ...
            >
              <div className="text-center">
                ...
                <div className="flex justify-center gap-4">
                  <div className="text-center">
                    <div className="text-3xl font-extrabold" style={{ color: 'var(--accent-purple)' }}>500+</div>
                    <div className="text-sm" style={{ color: 'var(--text-muted)' }}>Teachers</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-extrabold" style={{ color: 'var(--accent-teal)' }}>1000+</div>
                    <div className="text-sm" style={{ color: 'var(--text-muted)' }}>Exercises</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-extrabold" style={{ color: 'var(--accent-coral)' }}>5</div>
                    <div className="text-sm" style={{ color: 'var(--text-muted)' }}>Grade Levels</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          >
            <span className="text-white/40 text-sm">
              © 2025 StudyComp. All rights reserved.
            </span>
